...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        shifted = shifted_lower + shifted_lower.upper()
        
        return dict(zip(string.ascii_letters, shifted))
    ...
    def apply_shift(self, shift):
        ...
        for char in self.message_text:
            if (char in string.punctuation) or char.isspace() or char.isdigit():
                ...
                shifted_message_text += mapping[char]
...
class PlaintextMessage(Message):
    ...
    def change_shift(self, shift):
        ...
        Returns: nothing
        '''
        self = self.__init__(self.message_text, shift)
...
#    print('Actual Output:', ciphertext.decrypt_message())
    ...
    plaintext_2 = PlaintextMessage('MIT OCW 6.0001', 26)
    print('Test case 2 PlaintextMessage')
    print('Expected Output: MIT OCW 6.0001')
    print('Actual Output:', plaintext_2.get_message_text_encrypted())
    print('Change shift to 3...')
    plaintext_2.change_shift(3)
    print('Expected Output: PLW RFZ 6.0001')
    print('Actual Output:', plaintext_2.get_message_text_encrypted())
    ...
    ciphertext_2 = CiphertextMessage('Wklv lv whvw fdvh 2$#%#^')
    print('Test case 2 CiphertextMessage')
    print('Expected Output:', (23, 'This is test case 2$#%#^'))
    ...
    # of the residents of East Campus to become Jack Florey for a few 
    # nights each year to educate incoming students in the ways, means, 
